...
const ModalPopup = ({ visible, setLoading }) => {
    ...
    return (
        visible && (
            <div className="fixed top-0 left-0 w-full h-full bg-green-200 flex items-center justify-center z-50">
                    ...
                    {!setLoading ? (
                        <>
                            <div className="flex flex-col items-center justify-center max-w-72 sm:max-w-[25rem]">
                                ...
                                <p className="mb-6">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quo harum itaque repudiandae molestiae a.</p>
                                {/* <p className="self-start mb-6">Daca fisierul nu s-a salvat automat. <a className="underline  text-blue-900 text-md pointer" onClick={handleClickDw}> Click aici!! </a></p> */}
                        ...
                        <>
                            <h2 className="text-2xl font-bold">Va rugam asteptati</h2>

                            <p className="text-center mb-6">Datele se trimit...</p>
